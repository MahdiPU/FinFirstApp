...
@section('content')
    <div class="container d-grid align-content-center h-max justify-content-center">
                ...
                <form method="POST" action="{{route('register')}}">
                    ...
                    <div class="row text-center justify-content-center">
                        ...
                        <div class="col-11 col-md-5 mb-2  mx-2">
                            ...
                            <input class="form-control bg-dark text-white" type="password" name="password" id="password"
                                   required
                        ...
                        <div class="col-11 col-md-5 mb-2  mx-2">
                            ...
                            <select class="single-select bg-dark text-white w-100" name="blood_type" id="blood_type"
                                    required
                        ...
                        <div class="col-11 col-md-5 mb-2  mx-2">
                            ...
                            <select class="single-select bg-dark text-white w-100" name="gender" id="gender" required
